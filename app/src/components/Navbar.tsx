      ...
      <motion.nav initial={{ y: -100 }} animate={{ y: 0 }} className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
        <div className="bg-slate-900/80 backdrop-blur-xl rounded-full px-8 py-3 border border-slate-800/50 shadow-2xl w-full md:w-fit max-w-2xl">
          <div className="flex items-center justify-between gap-8 md:gap-12">
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:shadow-cyan-500/30 transition-all duration-300">
                <svg
              ...
              <span className="font-bold text-lg bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-300 tracking-wider">
                KingRovs
              </span>
            </motion.div>
